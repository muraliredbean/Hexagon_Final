	...
	$.scrollify({
        ...
        before:function() {
			...
			if (windowWidth > 959) {
				...
				if (currentSlide.context.id == "section-eight" || currentSlide.context.id == "about-section-2"  || currentSlide.context.id == "about-section-three" || currentSlide.context.id == "about-section-four"){				
					$("#page_nav").hide();
					if (currentSlide.context.id == "section-eight"){
						$("#section-eight").css("height","auto");
					}
